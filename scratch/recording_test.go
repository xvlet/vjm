...
func TestRecordingControllerParsing(t *testing.T) {
	absPath, err := filepath.Abs("../tests/logic-controller/test_recording_controller.jmx")
	if err != nil {
	...
	// Recording Controller is completely transparent.
